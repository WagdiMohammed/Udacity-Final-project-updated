         ...
         stage('Upload to AWS') {
              steps {
                  ...
                  sh '''
                         ...
                         sleep 5m
                         aws cloudformation create-stack --stack-name udacityfinalproject --template-body  file://servers-kube.yaml   --region us-west-2  --parameters file://servers-paramas.json
                         sleep 5m 
